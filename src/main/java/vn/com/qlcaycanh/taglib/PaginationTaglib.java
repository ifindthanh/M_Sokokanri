...
public final class PaginationTaglib extends AbstractTaglib
{
	...
	protected void printUI(JspWriter out) throws IOException
	{
		...
		out.write(IMessage.getLabelMaxOfDisplay(LocaleContextHolder.getLocale()));
		out.write("</li>");
		...
		out.write(IMessage.getLabelTotalRecords(LocaleContextHolder.getLocale()));
		out.write(":");
		out.write(String.valueOf(this.count)); 

		String toAppendText = IMessage.getLabelNumberOfDisplay(LocaleContextHolder.getLocale()) + " ";
