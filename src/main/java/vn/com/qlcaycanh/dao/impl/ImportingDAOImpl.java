...
public class ImportingDAOImpl implements ImportingDAO {
    ...
    public List<ImportingEntity> getAllItems(OrderSearchCondition searchCondition, SortCondition sortCondition, Integer offset, Integer maxResults) throws MyException {
        try {
            Session session = this.sessionFactory.getCurrentSession();
