...
import vn.com.qlcaycanh.authentication.*;
import vn.com.qlcaycanh.i18n.*;
import vn.com.qlcaycanh.javabean.*;

public class Utils
{
    public static void validateUser(UserRegistration userRegistration) throws MyException {
        ...
        throws MyException
    {
        if (newPassword == null || newPassword.length() < 6)
        {
            throw new MyException(
                IMessage.getMessageErrorInvalidPasswordLength(LocaleContextHolder.getLocale()));
	...
	public static void checkEmail(String email) throws MyException
	{
	    if (Utils.isEmpty(email)) {
            throw new MyException(IMessage.getMessageErrorEmailCannotBeEmpty(LocaleContextHolder.getLocale()));
        }
		...
		{
			throw new MyException(
				IMessage.getMessageErrorInvalidEmail(LocaleContextHolder.getLocale()));
		}
