    ...
    $.fn.freezeHeader = function (params) {
        ...
        function cloneHeaderRow(obj) {
            ...
            obj.container.find('th').each(function (index) {
                ...
                $(this).attr('onclick', 'doSort(\''+obj.id+'\', \''+$(this).attr('id')+'\' )');
                if ($(this).attr("data-sortable") != undefined &&  $(this).attr("data-sortable") == "false") {
            ...
            obj.container.find('table').each(function (index) {
            	...
            	$(this).css({ 'box-shadow': "0 2px 2px 0 #abc2eb" });
            });
...
function freezeHeader() {
	$("#tableList").freezeHeader({ 'offset': '92px' });
}

function doSort(myTable, theader) {
	$("#"+myTable).find("#" + theader).trigger( "click" );
	
	$("#"+myTable+"clone").find("th").each(function(){
		var element = $(this);
		if (element.attr("data-sortable") != undefined &&  element.attr("data-sortable") == "false") {
			return;
		}
