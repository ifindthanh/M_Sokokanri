			...
			<div class="body_container">
				<div class="container body">
					<div class="main_container">
						<div class="">
							<form id="listImportingForm" onsubmit="return form_validate();"
											...
											<div class="x_content">
												...
												<div class="row">
													...
													<div class="form-group">
														...
														<label class="control-label col-xs-1" for="first-name">受入指示日</label>
														<div class="col-xs-2">
													...
													<div class="form-group pull-center" style="margin-bottom: 0; display: inline;">
														<div class="col-xs-5">
															<a class="btn left" href="upload" onclick="checkSokoCdSelected(event)"
																...
																<i class="fa fa-upload" aria-hidden="true" ></i> QS1をインポート
															</a>
														</div>
