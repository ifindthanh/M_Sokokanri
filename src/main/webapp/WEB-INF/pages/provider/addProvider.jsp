											...
											<div class="row">
												<div>
													...
													<form:form modelAttribute="provider" method="POST"
														action="../provider/them-moi" enctype="multipart/form-data"
														class="form-horizontal div-center" id="addProvider">
																		...
																		<div class="row">
																			...
																			<div class="form-group">
																				<label
																						...
																						for="provider-name">Tên nhà cung cấp </label>
																				<div class="col-md-6 col-sm-6 col-xs-12">
																					<input id = "provider-name" type="text" name="name" class="form-control has-feedback-left" maxlength="30"
																						   value="${provider.name }" />
																				</div>
																			</div>
																			<div class="form-group">
